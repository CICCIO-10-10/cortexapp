/**
 * ui/views/CreateDeckView.js — Phase 17 (semplificata 17/07/2026)
 *
 * Estratto da #view-create dentro #page-materiale (index.html).
 * Fornisce il form completo per creare/modificare una materia.
 *
 * SEMPLIFICAZIONE 17/07: vista principale ridotta all'essenziale
 *   (Nome → Materiale → Genera/Salva). Tutto il resto — info esame,
 *   template, personalizzazione IA, flashcard manuali — è collassato in
 *   un <details> "Opzioni avanzate". Nessun ID rimosso: la logica di
 *   salvataggio e _resetForm continua a funzionare identica.
 *
 * Lifecycle:
...
<div style="padding: 100px 32px 120px; max-width: 820px; margin: 0 auto;">
    ...
    <div class="input-area" style="margin-bottom:16px;">
        ...
        <input type="text" id="deck-name" aria-label="Nome della materia" placeholder="es. Anatomia, Diritto Privato, Storia..." />
    </div>

    <!-- 2. MATERIALE (il cuore) -->
    ...
    <!-- 3. OPZIONI AVANZATE (collassate — facoltative) -->
    <details style="margin-top:16px; border:1px solid var(--border); border-radius:14px; background:rgba(255,255,255,0.02); overflow:hidden;">
        <summary style="cursor:pointer; padding:14px 18px; font-weight:800; font-size:0.9rem; color:var(--text); list-style:none; display:flex; align-items:center; gap:8px;">
            ⚙️ Dettagli esame e opzioni <span style="color:var(--text-muted); font-weight:600; font-size:0.8rem;">(facoltativo)</span>
        </summary>
        <div style="padding:4px 18px 18px;">

            <!-- AI CUSTOMIZATION BAR -->
            <div class="input-area" style="margin-bottom:16px; border:1px solid var(--accent); background:rgba(139,92,246,0.05);">
            ...
            <div class="input-area" style="margin-bottom:16px;">
                ...
                <div class="input-row">
                    ...
                    <div>
                        <label for="exam-topics">🎯 Argomenti / Focus</label>
                        <input type="text" id="exam-topics" aria-label="Argomenti principali dell'esame"
                            placeholder="es. Contratti, Successioni — quello che conta di più" />
                    </div>
                </div>
